...
public class Main {
    public static void main(String []args) {
        ...
        for (int i = 0;i < times; i++) {
            ...
            int lengthOfWord2 = lengthOfWord;
            for (int j =0;j < lengthOfWord;j++) {
                switch (indexInPairs[j]) {
                    ...
                    case 25: {
                        indexInPairs[j] = 0;
                        lengthOfWord2--;} break;
                    case 2:{appear[1] = 1;}   break;
                    case 3:{appear[2] = 1;}   break;
                    case 4:{appear[3] = 1;}   break;
                    case 6:{appear[5] = 1;}   break;
                    case 7:{appear[6] = 1;}   break;
                    case 8:{appear[7] = 1;}   break;
                    case 10:{appear[9] = 1;}   break;
                    case 11:{appear[10] = 1;}   break;
                    case 12:{appear[11] = 1;}   break;
                    case 13:{appear[12] = 1;}   break;
                    case 14:{appear[13] = 1;}   break;
                    case 16:{appear[15] = 1;}   break;
                    case 17:{appear[16] = 1;}   break;
                    case 18:{appear[17] = 1;}   break;
                    case 19:{appear[18] = 1;}   break;
                    case 20:{appear[19] = 1;}   break;
                    case 22:{appear[21] = 1;}   break;
                    case 24:{appear[23] = 1;}   break;
                    case 26:{appear[25] = 1;}   break;
                }
            }for (int j = 0; j < 26; j++) {
                if (appear[j] == 1) {
                    realAppear ++;
            ...
            tempCal.add(-100);
            a1:for (int j = 0; j < lengthOfWord;j++) {

                if ( tempCal.indexOf(indexInPairs[j]) == -1 && indexInPairs[j] != 0) {
                    numberList[temp5] = indexInPairs[j];
                    temp5++;
                    tempCal.add(indexInPairs[j]);
                }
                if (temp5 == realAppear) {break a1;}
...
//          }
            ...
            //for (int j = 0;j< lengthOfWord;j++) {
            //  System.out.println(indexInPairs[j]);
            //}
            ...
            int calcalus = 0;
            tempCircle: for (int j = 0;j < temp3; j++) {
                int tempNumber1 = temp3 - j;
                String tempString3 = tentoTwo(tempNumber1);
                ...
                }calcalusfinal = calcalusfinal > calcalus? calcalusfinal: calcalus;
    ...
    public static String tentoTwo (int a) {
        String two = Integer.toBinaryString(a);
        return two;
    }
}