...
public class Main {
    ...
    public static void main(String args[]) throws IOException {
        ...
        a1: for (int t = in.nextInt(); t > 0; t--) { //As same as scanner.nextInt()
    ...
    public static int[] getNext(String temp) {
        ...
        for(int i = BasicLength-1;i >0;i--) {
            BasicNext[i] = BasicNext[i-1];
        }BasicNext[0] = -1;
        return BasicNext;
    }
