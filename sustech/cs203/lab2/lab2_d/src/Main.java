...
//      if (finalNumber == middle -1 && Judgement(diffArray.length,OrdersArray,middle-1,arrayDays) == 1  ) {
//          temp =finalNumber;
//        break a1;
//      }
//      else if (begin == middle + 1 && Judgement(diffArray.length,OrdersArray,middle+1,arrayDays) == -1 ) {
//        
//      }
            temp = begin;
        }
