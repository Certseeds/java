...
public class SessionTests {
    ...
    @Autowired
    public SessionTests(Token staticToken, Email emailResource, MockMvc mvc, ObjectMapper mapper, ObjectWriter ow, JavaMailSender mailSender, Token tokenResource) {
    ...
    private final Email emailResource;
